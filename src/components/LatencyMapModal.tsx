      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="sharp-card bg-[#0b0f19] border border-border-subtle border-t-4 border-t-primary shadow-2xl max-w-4xl w-full my-auto overflow-hidden relative"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Header */}
            <div className="p-4 sm:p-6 border-b border-border-subtle bg-bg-surface/50 flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-primary/10 border border-primary/30 flex items-center justify-center text-primary relative">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="text-base sm:text-lg font-black uppercase italic tracking-tighter text-white">
                      HOTFAST<span className="text-primary not-italic">PH</span> LATENCY MAP
                    </h3>
                    <span className="px-2 py-0.5 bg-green-500/10 border border-green-500/30 text-green-400 text-[9px] font-black uppercase tracking-widest">
                      ACTIVE NODE
                    </span>
                  </div>
                  <p className="text-xs text-text-muted font-bold tracking-tight mt-0.5">
            ...
            {/* Map Action Toolbar */}
            <div className="px-4 sm:px-6 py-2.5 bg-bg-surface/30 border-b border-border-subtle flex flex-wrap items-center justify-between gap-3 text-xs">
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-black uppercase tracking-widest text-text-muted">Map Engine:</span>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3.5 py-1.5 bg-primary hover:bg-primary-dark text-white text-[10px] font-black uppercase tracking-widest transition-all shadow-md shadow-primary/20 flex items-center gap-1.5 italic cursor-pointer"
                >
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-bg-base border border-border-subtle hover:border-primary/50 text-white text-[10px] font-black uppercase tracking-widest transition-all items-center gap-1.5 cursor-pointer flex"
                >
            ...
            <div className="relative w-full h-[360px] sm:h-[440px] bg-slate-950 overflow-hidden border-b border-border-subtle">
              {/* Map Iframe */}
              <iframe
              ...
              <div className="absolute top-3 left-3 z-10 pointer-events-none">
                <div className="sharp-card bg-bg-base/90 backdrop-blur-md border border-border-subtle p-3 text-[10px] font-mono shadow-xl">
                  ...
                  <div className="text-white font-bold tracking-wider">
                    CARRIER: <span className="text-green-400 font-normal">100% OPTICAL REDUNDANCY</span>
                  </div>
                  <div className="text-text-muted mt-1 text-[9px]">
              ...
              <div className="absolute bottom-3 right-3 z-10">
                <button
                  onClick={openGoogleMapsDirect}
                  className="px-3 py-1.5 bg-bg-base/90 backdrop-blur-md border border-primary/50 hover:bg-primary hover:text-white text-white text-[10px] font-black uppercase tracking-widest transition-all shadow-xl flex items-center gap-2 cursor-pointer"
                >
                  <span>Interactive Google Map</span>
                  <ExternalLink size={12} className="text-primary group-hover:text-white" />
                </button>
              </div>
            </div>

            {/* Telemetry & Node Statistics Grid */}
            <div className="p-4 sm:p-6 bg-bg-surface/30">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4">
                <div className="bg-bg-base p-3 border border-border-subtle">
                  <div className="text-[9px] uppercase tracking-widest text-text-muted font-black mb-1">
                    Live Latency
                  </div>
                  <div className="text-xl sm:text-2xl font-black italic tracking-tight text-primary font-mono flex items-baseline gap-1">
                    {currentPing}
                    <span className="text-xs text-text-muted font-sans font-bold not-italic">ms</span>
                  </div>
                  <div className="text-[9px] text-green-400 font-mono mt-0.5 flex items-center gap-1">
                ...
                <div className="bg-bg-base p-3 border border-border-subtle">
                  ...
                  <div className="text-xl sm:text-2xl font-black italic tracking-tight text-white font-mono flex items-baseline gap-1">
                    12.0
                ...
                <div className="bg-bg-base p-3 border border-border-subtle">
                  ...
                  <div className="text-xl sm:text-2xl font-black italic tracking-tight text-green-400 font-mono flex items-baseline gap-1">
                    99.98%
                  </div>
                  <div className="text-[9px] text-text-dim font-mono mt-0.5 flex items-center gap-1">
                    <ShieldCheck size={10} className="text-green-400" /> Fully Operational
                  </div>
                </div>
              </div>

              {/* Bottom detail row */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pt-3 border-t border-border-subtle text-xs">
                <div className="flex items-center gap-2 text-text-dim text-[11px] font-mono">
                  <Radio size={14} className="text-primary shrink-0" />
                  <span>
                    Uplink Gateway: <strong className="text-white">Western Visayas Carrier Edge Station • Direct Peer Link</strong>
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="text-[10px] font-black uppercase tracking-wider text-text-muted hover:text-primary transition-colors flex items-center gap-1.5 cursor-pointer"
                  >
                    <RefreshCw size={12} className={isTestingPing ? "animate-spin text-primary" : ""} />
